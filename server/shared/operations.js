...
export const OPERATIONS = [
  ...
  {
    operation: 'DOWNLOAD_TEMPLATE_FOR_SENIOR',
    object: 'seniors',
    accessToAllOps: false,
    operationName: 'OPS.DOWNLOAD_TEMPLATE.NAME',
  ...
  {
    operation: 'UPLOAD_LIST_OF_SENIORS',
    object: 'seniors',
    accessToAllOps: false,
    operationName: 'OPS.BULK_UPLOAD.NAME',
  ...
  // --- Volunteers ---
  {
    operation: 'ALL_OPS_VOLUNTEERS',
    object: 'volunteers',
    accessToAllOps: true,
    operationName: 'OPS.ALL_OPS.NAME',
    description: 'Full access to all volunteer operations',
    objectName: 'OBJECT.VOLUNTEERS',
  },
  {
    operation: 'ADD_NEW_VOLUNTEER',
    object: 'volunteers',
    accessToAllOps: false,
    operationName: 'OPS.ADD.NAME',
  ...
  {
    operation: 'VIEW_VOLUNTEER',
    object: 'volunteers',
    accessToAllOps: false,
    operationName: 'OPS.VIEW.NAME',
    description: 'View volunteer profile',
    objectName: 'OBJECT.VOLUNTEERS',
  },
  {
    operation: 'EDIT_VOLUNTEER',
    object: 'volunteers',
    accessToAllOps: false,
    operationName: 'OPS.EDIT.NAME',
    description: 'Edit volunteer profile',
    objectName: 'OBJECT.VOLUNTEERS',
  },
  {
    operation: 'DELETE_VOLUNTEER',
    object: 'volunteers',
    accessToAllOps: false,
    operationName: 'OPS.DELETE.NAME',
    description: 'Permanently delete a volunteer profile',
    objectName: 'OBJECT.VOLUNTEERS',
  },
  {
  ...
  },
  {
    ...
    accessToAllOps: false,
    operationName: 'OPS.BULK_UPLOAD.NAME',
    description: 'Bulk update volunteer list via XLSX upload',
    objectName: 'OBJECT.VOLUNTEERS',
  },
  {
    operation: 'VIEW_LIMITED_VOLUNTEERS_LIST',
    object: 'volunteers',
    accessToAllOps: false,
    operationName: 'OPS.VIEW_LIMITED_LIST.NAME',
  ...
  // --- Celebrators ---
  {
    ...
    accessToAllOps: true,
    operationName: 'OPS.ALL_OPS.NAME',
    description: 'Full access to all recipient operations',
    objectName: 'OBJECT.RECIPIENTS',
  },
  {
    operation: 'ADD_NEW_RECIPIENT',
    object: 'recipients',
    accessToAllOps: false,
    operationName: 'OPS.ADD.NAME',
    ...
    }, */
  {
    ...
    description: 'Bulk create recipients list',
    objectName: 'OBJECT.RECIPIENTS',
  },
  {
    operation: 'EDIT_RECIPIENTS_LIST',
    object: 'recipients',
    accessToAllOps: false,
